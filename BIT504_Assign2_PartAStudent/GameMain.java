...
public class GameMain extends JPanel implements MouseListener {
    ...
    // The currentState variable declared here
     ...
     * which will call the methods to check for winner or Draw. If none then GameState
     * remains playing. If win or Draw then call is made to method that resets the
     * game board. Finally, a call is made to refresh the canvas so that the new
     * symbol appears
     */
